package com.harry.springbootmall.dao.impl;
...
import com.harry.springbootmall.rowMapper.ProductRowMapper;
...
public class ProductDaoImpl implements ProductDao {
    ...
    public Integer createProduct(ProductRequest productRequest) {
        ...
        String sql = "INSERT INTO product(product_name, category, " +
                "image_url, price, stock, description, created_date, " +
                "last_modified_date) VALUES (:productName, :category , :imageUrl, :price ," +
